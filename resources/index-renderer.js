...
const mangaTemplate = $(`
<div class="manga">
    <img src="./resources/img/manga placeholder.jpg">
    <div id="rating">
    ...
    <div class="manga-info">
        <span id="latestchap">24</span>
        <span class="label">Latest Chapter:</span>
        <hr>
        <span id='title'>Matchless Emperor Lies Of The Sheriff Evans: Dead Or Love</span>
    </div>
</div>
`)
...
async function updateMangaList(source,page){
    ...
    for(obj of mangaList){
        ...
        $manga.find('img').prop('src',obj.image)
